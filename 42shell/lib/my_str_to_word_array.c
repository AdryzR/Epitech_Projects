...
static int size_of_word(char *word, char *delim)
{
    int length = 0;
...
static int number_of_words(char *str, char *delim)
{
    int nb_words = 0;
...
static int set_words(char **words, char *str, char *delim)
{
    int word_len = 0;
    int pos_char = 0;
    ...
    for (int pos_words = 0; *str; ++pos_words) {
        ...
        CHECK_MALLOC(words[pos_words], 84);
